            ...
            <div className="flex items-center gap-4">
                ...
                <div className="relative" ref={profileMenuRef}>
                    <div className="flex items-center gap-4">
                        ...
                        {showProfileMenu && (
                            <div className="absolute right-0 mt-12 md:mt-2 w-56 bg-brandIndigo rounded-xl shadow-xl border border-white/10 py-1 z-50 animate-in fade-in zoom-in-95 duration-200">
                                <div className="px-4 py-2 border-b border-white/5 md:hidden">
                                    <p className="text-xs font-bold text-brandSky tracking-wider uppercase mb-2">Menu</p>
                                    <Link
                                        to="/user"
                                        className="flex items-center gap-3 py-2 text-sm text-gray-300 hover:text-white"
